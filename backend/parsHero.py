...
#/html/body/div[3]/div[3]/div[5]/div[1]/div[1]/div[1]/table/tbody/tr[1]/td[2]/b/a
rows = driver.find_elements(By.XPATH, "/html/body/div[3]/div[3]/div[5]/div[1]/div[1]/div")
for row in rows:
    title = row.find_element(By.XPATH, "table/tbody/tr[1]/td[2]/b/a")
    #print(title.text)
    description = row.find_element(By.XPATH, "table/tbody/tr[3]/td")
    #print(description.text)
    image = row.find_element(By.XPATH, "table/tbody/tr[1]/td[1]/div/span/a/img")
    #print(image.get_attribute("src"))

    with connection.cursor() as cursor:
        sql = """
                INSERT INTO heroes (name, imageUrl, description) 
                VALUES (%s, %s, %s)
                ...
                """
        values = (title.text, image.get_attribute("src"), description.text)
...
for hero in heroes:
    ...
    butons = driver.find_elements(By.XPATH, "/html/body/div[3]/div[3]/div[5]/div[1]/div[2]/ul/li")
    abilities = driver.find_elements(By.XPATH, "/html/body/div[3]/div[3]/div[5]/div[1]/div[2]/div")
#/html/body/div[3]/div[3]/div[5]/div[1]/div[2]/ul/li[1]
